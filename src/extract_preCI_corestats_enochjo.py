...
#                         Vapr_up = np.full(ncores_up, np.NaN, dtype=np.float32) # EJ
                        ...
                        # Thte_mean_pr3 = np.full(ncores_up, np.NaN, dtype=np.float32)
                        Thte_mean_pr6 = np.full(ncores_up, np.NaN, dtype=np.float32)
                        # Thte_mean_pr9 = np.full(ncores_up, np.NaN, dtype=np.float32)
...
#                         WE_up = np.full(ncores_up, np.NaN, dtype=np.float32) # EJ
                        ...
                        # RH_mean_pr3 = np.full(ncores_up, np.NaN, dtype=np.float32)
                        RH_mean_pr6 = np.full(ncores_up, np.NaN, dtype=np.float32)
                        # RH_mean_pr9 = np.full(ncores_up, np.NaN, dtype=np.float32)
...
#                         cell_Vapr_up[icell, z, 0:ncores_save_up] = Vapr_up[0:ncores_save_up] # EJ
                        ...
                        # cell_ThteMean_pr3[icell , z, 0:ncores_save_up] = Thte_mean_pr3[0:ncores_save_up]
                        cell_ThteMean_pr6[icell , z, 0:ncores_save_up] = Thte_mean_pr6[0:ncores_save_up]
                        # cell_ThteMean_pr9[icell , z, 0:ncores_save_up] = Thte_mean_pr9[0:ncores_save_up]
